...
// This matches the implementation in src/core/infrastructure/ProcessManager.ts lines 95-100
...
describe('getChildProcesses platform behavior', () => {
  ...
  it('should return empty array on non-Windows platforms (darwin)', async () => {
    ...
    const { getChildProcesses } = await import('../../src/core/infrastructure/ProcessManager.js');
