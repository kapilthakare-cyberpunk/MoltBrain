 ...
 * - Session routes from src/core/worker/http/routes/SessionRoutes.ts
 * - Search routes from src/core/worker/http/routes/SearchRoutes.ts
 */
...
mock.module('../../src/core/worker/http/middleware.js', () => ({
  createMiddleware: () => [],
...
// Import after mocks
import { Server } from '../../src/core/server/Server.js';
import type { ServerOptions } from '../../src/core/server/Server.js';
