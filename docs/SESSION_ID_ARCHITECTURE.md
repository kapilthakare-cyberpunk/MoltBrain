...
claude-recall uses **two distinct session IDs** to track conversations and memory:
...
- **Implementation**: `src/core/worker/SDKAgent.ts` (lines 72-94)
- **Database Schema**: `src/core/sqlite/SessionStore.ts` (line 95-104)
