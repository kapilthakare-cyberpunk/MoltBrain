...
```json
{
  "CLAUDE_RECALL_ENDLESS_MODE": "false",  // Default: disabled
  "CLAUDE_RECALL_ENDLESS_WAIT_TIMEOUT_MS": "90000"  // 90 second timeout
}
```
...
```bash
# Navigate to your claude-recall installation
